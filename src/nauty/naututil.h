...
extern long hash(setword*,long,int);
...
extern void putset(FILE*,setword*,int*,int,int,boolean);
extern void putset_firstbold(FILE*,setword*,int*,int,int,boolean);
...
extern long sethash(setword*,int,long,int);
extern int setinter(setword*,setword*,int);
extern int setsize(setword*,int);
